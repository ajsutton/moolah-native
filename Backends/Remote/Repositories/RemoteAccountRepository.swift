        ...
        do {
            ...
            if let decodingError = error as? DecodingError {
                ...
                case .typeMismatch(let type, let context):
                    logger.error("   Type mismatch: expected \(String(describing: type)) (context: \(context.debugDescription))")
                case .valueNotFound(let type, let context):
                    logger.error("   Value not found: \(String(describing: type)) (context: \(context.debugDescription))")
