...
extension InstrumentAmount {
  ...
  /// with `InstrumentAmountView` and any future view rendering an amount
  /// with the standard convention. Callers that need a different rule
  /// pass a `colorOverride` instead.
