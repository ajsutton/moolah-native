...
struct MigrationProfileNamingTests {
  ...
  @Test func sourceLabel_plainName_appendsRemote() {
    let result = MigrationProfileNaming.sourceLabel(for: "Moolah")
    #expect(result == "Moolah (Remote)")
  }

  @Test func sourceLabel_alreadyHasRemote_unchanged() {
  ...
  @Test func targetLabel_plainName_appendsiCloud() {
    let result = MigrationProfileNaming.targetLabel(for: "Moolah")
    #expect(result == "Moolah (iCloud)")
  }

  @Test func targetLabel_hasRemoteSuffix_replacesWithiCloud() {
    let result = MigrationProfileNaming.targetLabel(for: "Moolah (Remote)")
    #expect(result == "Moolah (iCloud)")
  }

  @Test func targetLabel_alreadyHasiCloud_keepsiCloud() {
  ...
  @Test func migratedLabels_plainName_noConflicts() {
  ...
  @Test func migratedLabels_plainName_targetConflict() {
    let (source, target) = MigrationProfileNaming.migratedLabels(
  ...
  @Test func migratedLabels_remoteSource_replacesForTarget() {
    let (source, target) = MigrationProfileNaming.migratedLabels(
  ...
  @Test func migratedLabels_sourceRenameConflictsWithExisting() {
  ...
  @Test func migratedLabels_bothConflict() {
    let (source, target) = MigrationProfileNaming.migratedLabels(
