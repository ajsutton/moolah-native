...
struct IncomeExpenseAccessibilityLabelTests {
  ...
  func combinesAllColumns() {
    let data = [
      monthData(
        month: "202401", income: Decimal(string: "5000.00")!,
        expense: Decimal(string: "3000.00")!)
    ]
  ...
  func usesEarmarkTotalsWhenIncluded() {
    let data = [
      monthData(
        month: "202401", income: Decimal(string: "5000.00")!,
        expense: Decimal(string: "3000.00")!,
        earmarkedIncome: Decimal(string: "1000.00")!,
        earmarkedExpense: Decimal(string: "500.00")!)
    ]
  ...
  func totalSavingsIsCumulative() {
    let data = [
      monthData(
        month: "202402", income: Decimal(string: "5000.00")!,
        expense: Decimal(string: "3000.00")!),
      monthData(
        month: "202401", income: Decimal(string: "4000.00")!,
        expense: Decimal(string: "3500.00")!),
    ]
