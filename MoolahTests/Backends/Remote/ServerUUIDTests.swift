...
struct ServerUUIDTests {
  ...
  @Test
  func decodesUppercaseUUID() throws {
    let json = "\"E621E1F8-C36C-495A-93FC-0C247A3E6E5F\""
    let data = json.data(using: .utf8)!
    let result = try JSONDecoder().decode(ServerUUID.self, from: data)
    #expect(result.uuid == testUUID)
  ...
  @Test
  func decodesUnhyphenatedUUID() throws {
  ...
  @Test
  func roundTripPreservesUUID() throws {
  ...
  @Test
  func optionalNullDecodesAsNil() throws {
    let json = "null"
    let data = json.data(using: .utf8)!
    let result = try JSONDecoder().decode(ServerUUID?.self, from: data)
    #expect(result == nil)
  ...
  @Test
  func optionalEmptyStringDecodesAsNil() throws {
    let json = """
  ...
  @Test
  func optionalMissingKeyDecodesAsNil() throws {
    let json = """
